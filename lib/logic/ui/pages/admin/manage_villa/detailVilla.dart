...
class DetailVillaScreen extends StatelessWidget {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (villa.createdAt != null) ...[
                      _buildSectionTitle("Tanggal Ditambahkan"),
                      const SizedBox(height: 10),
                      _buildInfoRow(
                        icon: Icons.calendar_today_outlined,
                        text: DateFormat(
                          'dd MMMM yyyy',
                        ).format(villa.createdAt!),
                      ),
                    ],
                  ],
                ),
  ...
  void _showDeleteDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Apakah kamu yakin ingin menghapus "${villa.namaVilla}"?\nAksi ini tidak bisa dibatalkan.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
            child: const Text("Batal", style: TextStyle(color: AppColors.navy)),
          ),
          ElevatedButton(
            style: ElevatedButton.styleFrom(
            ...
            onPressed: () {
              context.read<VillaBloc>().add(DeleteVillaEvent(villa.id!));
              Navigator.pop(context); // kembali ke ManageVilla
            },
